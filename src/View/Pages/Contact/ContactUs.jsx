    ...
    return (
        <div className='container tw-mb-[5%]'>
            <div className='tw-my-[5%] '>
                <h1 className='tw-text-center'><span className='tw-bg-[#00AAA1] tw-text-white'>Contact</span> Us</h1>
                <div className='tw-my-10'>
                    <div className='row'>
                        <div className='col-lg-6 col-12'>
                            <div className='lg:tw-flex tw-block tw-gap-5 tw-mb-5'>
                                <input type="text" placeholder='Name' className='tw-border tw-p-2 lg:tw-w-1/2 w-100 lg:m-0 my-2 tw-rounded-md' />
                                <input type="email" placeholder='Email' className='tw-border tw-p-2 lg:tw-w-1/2 w-100 lg:m-0 my-2 tw-rounded-md ' />
                            </div>
                            <input type="text" placeholder='Subject' className='tw-border tw-p-2 tw-w-full tw-rounded-md tw-mb-5' />
                            <textarea name="" placeholder='Type your message' rows="5" className='w-100 tw-border tw-mb-5 tw-p-2 tw-rounded-md'></textarea>
                            <button className='tw-px-5 tw-py-2 tw-bg-[#00AAA1] tw-rounded-md tw-text-white'>Send message</button>
                        </div>
                        <div className='col-lg-6 col-12lg:m-0 my-2'>
                            <div>
                                <p className='tw-text-[15px] lg:tw-w-[75%] w-100'>Dynamically underwhelm integrated outsourcing  via timely models. Rapidiously reconceptualize visionary imperatives without
                                </p>
                                <ul className='tw-my-3 tw-flex tw-flex-col tw-gap-2'>
                                    <li>blog.notebook@gmail.com</li>
                                    <li>+886554 654654</li>
                                    <li>9567 Turner Trace Apt. BC C3G8A4
                                    </li>
                                </ul>
                                <div>
                                    <h6>Follow on:</h6>
                                    <div className='tw-my-2 tw-flex tw-gap-3'>
                                        <div className='tw-border tw-p-2 tw-rounded-md tw-bg-[#00AAA1]'>
                                            <svg width="14" height="15" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
